...
class GenericCodeConstant {
    ...
    const INVOICE = "INVOICE_PDF";
    const REFERRAL_BONUS_SMART_TABLE_EMAIL = "REFERRAL_BONUS_SMART_TABLE_EMAIL";
    const SMART_TABLE_BREAK_EMAIL = "SMART_TABLE_BREAK_EMAIL";
    const DEPOSIT_EMAIL = "DEPOSIT_EMAIL";
    const WITHDRAW_EMAIL = "WITHDRAW_EMAIL";
    const WITHDRAW_CHARGE_EMAIL = "WITHDRAW_CHARGE_EMAIL";
    const GLOBAL_ENTRY_EMAIL = "GLOBAL_ENTRY_EMAIL";
    const GLOBAL_TABLE_BREAK_EMAIL = "GLOBAL_TABLE_BREAK_EMAIL";
    const REGISTER_EMAIL = "REGISTER_EMAIL";
    const USER_ACTIVE_EMAIL = "USER_ACTIVE_EMAIL";
    const SMART_TABLE_BREAK_SMS = "SMART_TABLE_BREAK_SMS";
    const REFERRAL_BONUS_SMART_TABLE_SMS = "REFERRAL_BONUS_SMART_TABLE_SMS";
    const INVOICE_SMS = "INVOICE_SMS";
    const DEPOSIT_SMS = "DEPOSIT_SMS";
    const WITHDRAW_SMS = "WITHDRAW_SMS";
    const WITHDRAW_CHARGE_SMS = "WITHDRAW_CHARGE_SMS";
    const GLOBAL_ENTRY_SMS = "GLOBAL_ENTRY_SMS";
    const GLOBAL_TABLE_BREAK_SMS = "GLOBAL_TABLE_BREAK_SMS";
